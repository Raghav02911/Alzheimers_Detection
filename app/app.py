...
model_path = find_existing_path([
    ...
    resolve_asset_path('..', 'model', 'alzheimers_model.keras'),
    resolve_asset_path('alzheimers_model.keras'),
    resolve_asset_path('..', 'alzheimers_model.keras'),
])

try:
    if model_path is None:
        raise FileNotFoundError('Could not locate alzheimers_model.keras in model/ or the current app directory.')
...
if use_sample and not uploaded_file:
    sample_image_path = find_existing_path([
        ...
        resolve_asset_path('app', 'sample_mri.png'),
        resolve_asset_path('..', 'app', 'sample_mri.png'),
        resolve_asset_path('..', 'sample_mri.png'),
    ])
